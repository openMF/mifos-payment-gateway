...
CREATE TABLE `inbound_callback_log` (
  ...
  `callback_status_id` int(11) NULL,
  `callback_message` varchar(255) NULL,
  `callback_dtm` datetime NULL,
...
CREATE TABLE `inbound_request` (
  ...
  `transaction_type` enum('LOAN_REPAYMENT','RECURRING_DEPOSIT', 'VOLUNTARY_SAVINGS') NOT NULL,
  `mmp_id` bigint(20) NOT NULL,
  `mfi_id` bigint(20) NOT NULL,
  ...
  `requested_dtm` datetime NULL DEFAULT CURRENT_TIMESTAMP,
